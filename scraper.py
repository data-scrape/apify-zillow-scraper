#!/usr/bin/env python3
"""
Apify Zillow Scraper - Apify-style Zillow scraper alternative - free & open source
Open source scraper for apify zillow scraper, zillow scraper apify, apify alternative zillow
...
class ApifyZillowScraperScraper:
    """Scraper for Apify Zillow Scraper."""
...
def main():
    parser = argparse.ArgumentParser(description="Apify Zillow Scraper - Apify-style Zillow scraper alternative - free & open source")
    ...
    scraper = ApifyZillowScraperScraper(proxy=args.proxy)
